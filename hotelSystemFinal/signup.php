...
<html>
<head>
    <title>Alex Hotel Register</title>
...
<div class="container padd rounded boxSh formC">
  <form action="functions/signup.php" method="post" autocomplete="off">
    <div class="mb-3 mt-3">
    <h2>Register <i class="fa fa-user-o" aria-hidden="true"></i></h2><br />
    </div>
    <div class="mb-3 mt-3">
    ...
    <div class="form-check mb-3">
      ...
      <input type="submit" value="Register" class="lgbtn" />
</form>    
<hr class="hr" />    
<ul class="ulMenu">
...
<div class="row" style="width: 100%;">
<div class="col">
<a href="login.php" style="text-decoration: none;color: #fff;"><button class="btn btn-success boxSh">Login</button></a>    
</div>    
<div class="col">
